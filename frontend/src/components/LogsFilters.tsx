  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="relative">
        ...
        {showEvaluatorDropdown && (
          <div className="absolute mt-2 w-56 bg-white text-black border border-gray-700 rounded-xl shadow-xl z-50 py-2">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center justify-between gap-2 bg-[#0e1117] border border-gray-800 text-gray-300 text-xs font-bold rounded-lg px-4 py-2 w-36"
        >
          {filterStatus}
          <ChevronDown size={14} />
        </button>
        ...
        {showStatusDropdown && (
          <div className="absolute mt-2 w-48 bg-white text-black border border-gray-700 rounded-xl shadow-xl z-50 py-2">
